...
public static class GTTools
{
    ...
    {
        if (go == null) return;
        NavMeshAgent[] navs = go.GetComponentsInChildren<NavMeshAgent>();
    ...
    public static bool IsArrive(NavMeshAgent agent)
    {
        if(agent)
        {
    ...
    public static string GetRandomName()
    {
        if (mRandomNames == null)
        {
            ...
            TextAsset randomNameText = ZTResource.Instance.Load<TextAsset>("Text/Name/RandomNames");
    ...
    public static Animator LoadAnimator(GameObject model,string ctrlPath)
    {
        ...
        GameObject ctrl = ZTResource.Instance.Load<GameObject>(ctrlPath);
        if(ctrl==null)
        {
            return null;
        }
